...
- **Trọng tâm ngữ pháp:** modals, conditionals basics, sentence variety
- **Nhóm từ vựng:** advantages/disadvantages, problems/solutions, emotions
- **Speaking:** câu trả lời Part 2 trong 90 giây + Part 3 ở mức chuyển tiếp
- **Writing:** Task 2 mini essay: intro + one body paragraph
- **Reading:** paraphrase and reference words
- **Listening:** conversation function: suggestion, problem, solution
- **Nhiệm vụ nhẹ:** Thu âm 2 phút về một chủ đề quen thuộc.
- **Mốc kiểm tra:** Nói được 2 phút với ghi chú và biết quay lại sau khi mắc lỗi.

#### Nhịp học hằng ngày

| Day | Nhiệm vụ chính | Sản phẩm nhỏ | Ôn tập |
| --- | --- | --- | --- |
| Day 1 / Day 2 | Nắm lộ trình tuần và chép tay 5 câu mẫu. | Đọc to 5 câu mẫu. | Ôn 5 câu dễ nhất của tuần trước. |
| Day 3 / Day 4 / Day 5 | Học ngữ pháp ngắn và luyện có kiểm soát. | Viết 8 câu dùng điểm ngữ pháp của tuần. | Gấp tài liệu và viết lại 3 quy tắc bằng tiếng Việt. |
| Day 6 / Day 7 | Xây nhóm từ vựng theo chủ đề. | Làm 10 thẻ từ có cụm đi kèm, không chỉ ghi từ đơn. | Tự kiểm tra: English → Vietnamese → English. |
|  | Luyện nói có ghi âm. | Thu âm 60–90 giây. | Nghe lại một lần và chỉ ghi 2 điểm cần sửa. |
|  | Đọc/nghe một đoạn ngắn. | Trả lời câu hỏi ngắn. | Gạch chân 5 cụm hữu ích và dùng lại 2 cụm. |
...
### 5.12 Mini-mock và lộ trình tiếp theo

- **Mục tiêu tuần:** Em nhìn thấy mình đã có nền để đi tiếp.
- **Trọng tâm ngữ pháp:** full review through errors
- **Nhóm từ vựng:** personal weak rooms + IELTS bridge list
- **Speaking:** mini Speaking test with friendly rubric
- **Writing:** one Task 1 lite + one Task 2 paragraph
- **Reading:** two short passages
- **Listening:** two short audios/transcripts
- **Nhiệm vụ nhẹ:** Viết một lá thư ngắn gửi lại bản thân ở Week 0.
- **Mốc kiểm tra:** Hoàn thành được mini-mock 90 phút ở giai đoạn nối với IELTS
