...
export const ieltsGrammarExtra = {
  ...
  2: {
    'Số ít – Số nhiều & There is/are': [
      // —— Lỗi #1 của người Việt: quên thêm "s" cho danh từ số nhiều VÀ/HOẶC quên đổi be → are. ——
      { type: 'error', q: 'Many student is in my class.', answer: ['Many students are in my class.'], ex: 'Số nhiều cần cả hai: danh từ thêm "s" (students) và "be" đổi thành "are".' },
      { type: 'error', q: 'There is two windows in my room.', answer: ['There are two windows in my room.'], ex: '"two windows" số nhiều → There are, không phải There is.' },
      { type: 'error', q: 'This books is mine.', answer: ['These books are mine.'], ex: 'Danh từ số nhiều "books" cần "These" + "are", không phải "This" + "is".' },
      { type: 'error', q: 'I have three friend.', answer: ['I have three friends.'], ex: 'Đếm được từ 2 trở lên phải thêm "s": three friends.' },
      { type: 'cloze', q: 'There _____ one classroom on this floor. (be)', answer: ['is'], ex: 'Số ít "one classroom" → There is.' },
      { type: 'cloze', q: 'These _____ my favourite books. (be)', answer: ['are'], ex: 'Chủ ngữ số nhiều "These … books" → are.' },
    ],
  ...
  7: {
    'Articles & Prepositions — Mạo từ & giới từ theo cảnh sử dụng': [
      // —— Lỗi #1 của người Việt: bỏ mạo từ trước danh từ đếm được số ít; dùng sai giới từ trong cụm cố định. ——
  ...
  8: {
    ...
    'Conditionals & Sentence Variety — Câu điều kiện loại 1 và đa dạng câu': [
      // —— Lỗi #1 của người Việt: dùng "will" ở cả hai mệnh đề, hoặc quên chia động từ ở mệnh đề if; lặp "I think" nhiều lần và lặp danh từ thay vì dùng đại từ. ——
